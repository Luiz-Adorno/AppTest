...
public class GlassFragment extends Fragment {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (DocumentSnapshot document : task.getResult()) {
                                    ...
                                    getGlass(new GlassFragment.FirestoreCallback() {
                                        @Override
    ...
    private void getGlass(final GlassFragment.FirestoreCallback firestoreCallback, String docId, String gender, String cnpj) {
        ...
        productRef.whereEqualTo("cnpj_owner", cnpj).whereEqualTo("gender", gender).whereEqualTo("product_category", "Óculos de Grau").whereEqualTo("state",true)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
