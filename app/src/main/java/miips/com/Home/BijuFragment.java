...
public class BijuFragment extends Fragment {

    private FirebaseFirestore db;
    private BijuFragment context;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_biju, container, false);
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (DocumentSnapshot document : task.getResult()) {
                                    ...
                                    getBiju(new BijuFragment.FirestoreCallback() {
                                        @Override
    ...
    private void getBiju(final BijuFragment.FirestoreCallback firestoreCallback, String docId, String gender, String cnpj) {
        ...
        productRef.whereEqualTo("cnpj_owner", cnpj).whereEqualTo("gender", gender).whereEqualTo("product_category", "Bijuteria").whereEqualTo("state",true)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
