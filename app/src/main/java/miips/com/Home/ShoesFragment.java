...
public class ShoesFragment extends Fragment {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (DocumentSnapshot document : task.getResult()) {
                                    ...
                                    getShoes(new ShoesFragment.FirestoreCallback() {
                                        @Override
                                        public void onCallback(final ArrayList<Products> list) {
                                            if (!list.isEmpty()) {
                                                ...
                                                Log.d(TAG, "onCallback: shoes vazio unissex");
                                            }
                                        }
    ...
    private void getShoes(final ShoesFragment.FirestoreCallback firestoreCallback, String docId, String gender, String cnpj) {
        ...
        productRef.whereEqualTo("cnpj_owner", cnpj).whereEqualTo("gender", gender).whereEqualTo("product_category", "Calçado").whereEqualTo("state",true)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                Log.d(TAG, document.getId() + "shoesget => " + document.getData());
