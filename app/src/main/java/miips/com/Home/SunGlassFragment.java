...
public class SunGlassFragment extends Fragment {

    private FirebaseFirestore db;
    private SunGlassFragment context;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_sunglass, container, false);
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (DocumentSnapshot document : task.getResult()) {
                                    ...
                                    getSunGlass(new SunGlassFragment.FirestoreCallback() {
                                        @Override
    ...
    private void getSunGlass(final SunGlassFragment.FirestoreCallback firestoreCallback, String docId, String gender, String cnpj) {
        ...
        productRef.whereEqualTo("cnpj_owner", cnpj).whereEqualTo("gender", gender).whereEqualTo("product_category", "Óculos de sol").whereEqualTo("state",true)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
